            ...
            <Col md={8} lg={6} xl={5}>
              <Card className="overflow-hidden">
                <div className="bg-login text-center">
                  ...
                  <div className="position-relative">
                    ...
                    <p className="text-white-50 mb-0">Get your free BT_Solution account now</p>
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="mt-4 text-center">
                        <p className="mb-0">
                          By registering you agree to the BT_Solution{" "}
              ...
              <div className="mt-5 text-center">
                <p>Already have an account ? <a href="/pages-login" className="fw-medium text-primary">
                  Login</a> </p>
                <p>© {new Date().getFullYear()} BT_Solution. Crafted with <i
